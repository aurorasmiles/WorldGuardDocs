# -*- coding: utf-8 -*-
#
# WorldGuard Documentation documentation build configuration file, created by
...
html_context = {
    ...
    "source_repo": "WorldGuardDocs", # Repo name
...
htmlhelp_basename = 'WorldGuardDocumentationdoc'
...
latex_documents = [
  ('index', 'WorldGuardDocumentation.tex', u'WorldGuard Documentation Documentation',
   u'WorldGuard Team', 'manual'),
]
...
man_pages = [
    ('index', 'worldguarddocumentation', u'WorldGuard Documentation Documentation',
     [u'WorldGuard Team'], 1)
]
...
texinfo_documents = [
  ('index', 'WorldGuardDocumentation', u'WorldGuard Documentation Documentation',
   u'WorldGuard Team', 'WorldGuardDocumentation', 'One line description of project.',
   'Miscellaneous'),
]
